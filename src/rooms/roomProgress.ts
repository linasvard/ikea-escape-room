...
export function showRoom(roomNumber: number): void {
    document.querySelectorAll('.main-rooms').forEach(room => room.classList.add('hidden'));
...
export function initRoomProgress(): void { // denna funktion körs när man laddar eller refreshar sidan!
